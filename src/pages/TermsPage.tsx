          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Ovi Uvjeti poslovanja reguliraju odnos između Blok3 Akademija d.o.o. (u daljnjem tekstu: "Pružatelj usluge") 
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Pružatelj usluge: Blok3 Akademija d.o.o., Ulica blockchain tehnologije 42, 10000 Zagreb, OIB: 12345678901, 
                MBS: 081234567, upisana u sudski registar Trgovačkog suda u Zagrebu.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                korisnik može podnijeti reklamaciju putem e-maila: info@blok3.academy. Obvezujemo se 
            ...
            <section>
              ...
              <ul className="text-muted-foreground mt-2 space-y-1">
                <li>Email: info@blok3.academy</li>
